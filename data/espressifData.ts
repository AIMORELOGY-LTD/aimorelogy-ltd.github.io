...
export const ESPRESSIF_CHIPS: Record<string, ChipData> = {
  'esp32s3': {
    ...
    longDescription: [
      "The ESP32-S3-WROOM-1 and ESP32-S3-WROOM-1U are two powerful, generic Wi-Fi + Bluetooth LE MCU modules that are built around the ESP32-S3 series of SoCs. At the core of the modules is an Xtensa® dual-core 32-bit LX7 microprocessor operating at up to 240 MHz.",
      "On top of a rich set of peripherals, the acceleration for neural network computing and signal processing workloads provided by the SoC make the modules an ideal choice for a wide variety of application scenarios related to AI and Artificial Intelligence of Things (AIoT), such as wake word detection, speech commands recognition, face detection and recognition, smart home, smart appliances, smart control panel, and smart speakers.",
    ...
    faqs: [
      { question: "What is the operating temperature range?", answer: "Standard versions operate from –40 ~ 85 °C. The H4 series operates up to 105 °C." },
