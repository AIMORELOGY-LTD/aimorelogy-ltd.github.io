...
export const SOPHGO_CHIPS: Record<string, ChipData> = {
    ...
    'cv184': {
      ...
      name: 'CV184',
      series: 'VISION',
      tagline: '1.5T Dual-Core Vision SoC with ISP V4.0 & Smart Encoding',
      metaTitle: 'SOPHGO CV184x Vision SoC for FPV/UAV (CV1841C-P/CV1842C-P/CV1842H-P/CV1842HP/CV1843H-P) - ISP V4.0, Smart Encoding | AIMORELOGY',
      metaDescription: 'SOPHGO CV184x series (CV1841C-P, CV1842C-P, CV1842H-P/CV1842HP, CV1843H-P) delivers 1.5 TOPS TPU, ISP V4.0, and Smart Encoding (H.265/H.264/MJPEG) for FPV/UAV vision, gimbal tracking, smart cameras, and access control. Datasheet',
      description: 'Edge vision SoC featuring ISP V4.0, Smart Encoding, and edge large-model SDK support.',
      longDescription: [
          "The CV184x series is a high-performance visual processor designed for consumer, carrier, and professional security markets. It features a dual-core architecture (ARM Cortex-A53 @ 1.1GHz + RISC-V C906 @ 800MHz) and a self-developed TPU delivering 1.5 TOPS (INT8) with BF16 mixed precision support.",
          ...
          "CV184x provides SDK support for edge-side large-model workflows and is compatible with the OpenCLIP multimodal model, enabling generic object detection, image-text retrieval, and zero-shot inference. It comes with a rich library of turnkey algorithms including face detection, person/vehicle tracking, and helmet detection.",
      ...
      highlights: [
        ...
        'TPU: 1.5 TOPS @ INT8 / BF16 Mixed Precision',
        'ISP V4.0: 3DNR, DRC, PFR, Dehaze, Distortion Correction',
        'Smart Encoding + Intra4: Higher compression, better texture retention',
        'OpenCLIP + Edge LLM SDK: Zero-shot, Image-Text Retrieval',
      ...
      detailedFeatures: [
          ...
          { title: "Smart Encoding + Intra4", description: "Smart Encoding with Intra4 retains complex textures while reducing bitrate and storage cost." },
          { title: "OpenCLIP + Edge LLM SDK", description: "Supports image-text matching, zero-shot inference, and SDK workflows for edge-side large models." },
          { title: "High Performance TPU", description: "1.5 TOPS INT8 performance with BF16 support. Outperforms predecessors in ResNet50 and YOLOv5s benchmarks." },
      ...
      detailSections: [
        ...
        },
        {
          ...
          table: {
            headers: ["Feature", "CV1841C-P", "CV1842C-P", "CV1842H-P/CV1842HP", "CV1843H-P"],
            rows: [
              ["Processor", "CA53 1.1GHz + C906 800MHz", "CA53 1.1GHz + C906 800MHz", "CA53 1.1GHz + C906 800MHz", "CA53 1.1GHz + C906 800MHz"],
              ["DDR3 SiP", "1Gbit", "2Gbit", "2Gbit", "4Gbit"],
              ["TPU (INT8)", "~1.5 TOPS", "~1.5 TOPS", "~1.5 TOPS", "~1.5 TOPS"],
      ...
      specs: [
        ...
        { category: 'AI', key: 'TPU', value: '1.5 TOPS @ INT8 / BF16' },
        { category: 'Memory', key: 'Integrated', value: 'DDR3 512Mb / 1Gb / 2Gb / 4Gb' },
        { category: 'Video', key: 'ISP', value: 'ISP V4.0 (4K, 3DNR, DRC, PFR)' },
        { category: 'Video', key: 'Encoding', value: 'H.265/H.264/MJPEG Smart Encoding + Intra4' },
        { category: 'Video', key: 'Resolution', value: 'Max 8M@25fps + 2x 720P@25fps' },
