...
## OVIS
- OVIS: Захват изображения, ISP, ИИ-вычисления, кодирование видео и передача данных в одной модульной камере. Работает автономно или с Raspberry Pi и другими одноплатными компьютерами.
- https://aimorelogy.com/ru/products/ovis/ovis-camera-module/
