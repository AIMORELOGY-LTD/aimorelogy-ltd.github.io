      ...
      <section className="bg-white py-24 text-center">
        <div className="container mx-auto px-6">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link to={withLang(lang, '/products/sophgo/cv184')} className="border border-gray-300 text-gray-700 px-10 py-4 font-bold uppercase hover:border-gray-900 transition-colors">
