          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl">
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2 mb-8">
                ...
                <div className="text-gray-500 font-bold uppercase text-[10px] tracking-[0.12em] sm:tracking-[0.2em] break-words max-w-full">{cv184Ui.heroSeriesLabel}</div>
              </div>
              <h1 className="text-5xl sm:text-7xl md:text-9xl font-black uppercase mb-8 tracking-tighter text-gray-900 leading-[0.9] sm:leading-[0.85]">
                {displayName}
              </h1>
              <h2 className="text-xl sm:text-2xl md:text-4xl font-bold text-[#4f4398] mb-10 leading-tight tracking-tight max-w-3xl">
                {localizedProduct.tagline}
              </h2>
              <div className="flex flex-wrap gap-6">
                <button 
                  onClick={scrollToFooter}
                  className="bg-[#4f4398] text-white px-6 sm:px-10 md:px-12 py-4 sm:py-5 font-black uppercase tracking-[0.16em] sm:tracking-widest hover:bg-[#3e3479] transition-all flex items-center justify-center gap-3 shadow-2xl w-full sm:w-auto"
                >
        ...
        {isCv184 ? (
          <>
              ...
              <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                  <div className="lg:col-span-5">
                    <h3 className="text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[#4f4398] mb-8">{cv184Ui.productBrief}</h3>
                    <div className="space-y-6 text-gray-500 text-base leading-relaxed md:text-justify">
              ...
              <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row gap-20 items-center">
                  <div className="lg:w-3/5">
                    <div className="mb-12">
                      <h3 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase mb-4 tracking-tighter">{cv184Ui.systemArchitecture}</h3>
              ...
              <section className="py-32 bg-[#0a0a0a] text-white">
                <div className="container mx-auto px-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    <div>
                      <div className="text-[#4f4398] tech-mono text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.4em] mb-6">{cv184Ui.tpuEyebrow}</div>
                      <h2 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase mb-8 tracking-tighter">{cv184Ui.tpuTitle}</h2>
                    ...
                    <div className="bg-white/5 p-6 sm:p-10 lg:p-12 border border-white/10 rounded-sm">
                      <h4 className="tech-mono text-[10px] font-black text-[#4f4398] uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-12 text-center">{cv184Ui.tpuBenchmarks}</h4>
                      <div className="space-y-12">
                        {cv184SectionMap['tpu-acceleration'].stats?.map((stat, idx) => (
                          <div key={idx} className="relative">
                            <div className="flex justify-between items-end mb-4">
                              <span className="text-xs sm:text-sm font-black uppercase tracking-[0.12em] sm:tracking-widest break-words">{stat.label}</span>
                              <span className="text-2xl sm:text-3xl font-black text-[#4f4398]">{stat.value}</span>
                            </div>
              ...
              <section className="py-32 bg-white">
                <div className="container mx-auto px-6">
                  <div className="max-w-4xl mb-24">
                    <div className="text-[#4f4398] tech-mono text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.4em] mb-6">{cv184Ui.ispEyebrow}</div>
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase mb-8 tracking-tighter">{cv184Ui.ispTitle}</h2>
                    ...
                    {cv184SectionMap['isp-v4'].bullets?.map((bullet, idx) => {
                      ...
                      return (
                        <div key={idx} className="border-t-2 border-gray-100 pt-8">
                          ...
                          <p className="text-xs text-gray-400 leading-relaxed uppercase tracking-[0.12em] sm:tracking-widest break-words">{desc || title}</p>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="container mx-auto px-6">
                  <div className="flex flex-col lg:flex-row gap-20">
                    <div className="lg:w-1/3">
                      <h3 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase mb-8 tracking-tighter leading-[0.95] sm:leading-[0.9]">{cv184Ui.aiLibraryTitle}</h3>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                         {cv184Ui.aiCategories.map((cat, i) => (
                           <div key={i} className="bg-white p-4 border border-gray-200 text-center">
                              <div className="text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-widest text-[#4f4398]">{cat}</div>
                           </div>
                         ))}
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {cv184SectionMap['algorithms'].bullets?.map((algo, idx) => (
                          <div key={idx} className="flex items-center gap-4 px-6 py-4 bg-white border border-gray-100">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-[0.12em] sm:tracking-widest text-gray-700">{algo}</span>
                          </div>
                        ))}
                      </div>
                    </div>
            ...
            {cv184SectionMap['variant-comparison'] && (
              <section className="py-32 bg-white">
                <div className="container mx-auto px-6">
                  <h3 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase mb-16 tracking-tighter text-center">{cv184Ui.variantComparison}</h3>
                      ...
                      <thead>
                        <tr className="bg-gray-100 border-y-2 border-gray-900">
                          {cv184SectionMap['variant-comparison'].table?.headers.map((h, i) => (
                            <th key={i} className="p-4 sm:p-6 text-[9px] sm:text-[10px] font-black uppercase tracking-[0.12em] sm:tracking-[0.2em] text-gray-900 whitespace-normal">{h}</th>
                          ))}
                        </tr>
                      </thead>
                      <tbody className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.12em] sm:tracking-widest">
                        {cv184SectionMap['variant-comparison'].table?.rows.map((row, rIdx) => (
                          <tr key={rIdx} className="border-b border-gray-100">
                            {row.map((cell, cIdx) => (
                              <td key={cIdx} className={`p-4 sm:p-6 whitespace-normal ${cIdx === 0 ? 'bg-gray-50/50 font-black text-gray-900' : 'text-gray-500'}`}>
                                {cell}
                              </td>
                            ))}
                          </tr>
            ...
            <section className="py-32 bg-white border-b border-gray-100">
              <div className="container mx-auto px-6">
                <h3 className="text-center text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.5em] text-[#4f4398] mb-20">{cv184Ui.deploymentScenarios}</h3>
            ...
            <section className="py-32 bg-white">
              <div className="container mx-auto px-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-baseline sm:justify-between mb-16 sm:mb-20 border-b-4 border-gray-900 pb-8">
                  <h3 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter">{cv184Ui.datasheetTitle}</h3>
                  <div className="text-gray-400 font-bold uppercase tracking-[0.12em] sm:tracking-widest text-[10px] sm:text-xs">{cv184Ui.datasheetVersion}</div>
                </div>
                      ...
                      {Array.from(new Set(localizedProduct.specs.map(s => s.category))).map((cat, catIdx) => (
                        <React.Fragment key={catIdx}>
                          <tr className="bg-gray-50 border-b border-gray-200">
                            <td colSpan={2} className="py-6 px-4 sm:px-8 lg:px-10 text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.4em] lg:tracking-[0.5em] text-[#4f4398] whitespace-normal">
                              {cat}
                            </td>
                          </tr>
                          {localizedProduct.specs.filter(s => s.category === cat).map((spec, specIdx) => (
                            <tr key={specIdx} className="border-b border-gray-100 last:border-b-0">
                              <td className="py-4 sm:py-5 px-4 sm:px-8 lg:px-10 text-[11px] font-black uppercase tracking-[0.12em] sm:tracking-widest text-gray-400 w-full sm:w-1/3 border-r border-gray-100 whitespace-normal break-words leading-snug">
                                {spec.key}
                              </td>
                              <td className="py-4 sm:py-5 px-4 sm:px-8 lg:px-10 text-[11px] font-black text-gray-900 tracking-[0.12em] sm:tracking-widest uppercase whitespace-normal break-words leading-snug">
                                {spec.value}
                              </td>
                            </tr>
                          ))}
            ...
            <section className="py-40 bg-[#0a0a0a] text-center relative overflow-hidden">
              ...
              <div className="container mx-auto px-6 relative z-10">
                <h2 className="text-4xl sm:text-5xl md:text-8xl font-black text-white mb-12 uppercase tracking-tighter leading-none">
                  <Trans
                ...
                <button
                  onClick={scrollToFooter}
                  className="inline-block bg-white text-gray-900 px-8 sm:px-12 md:px-20 py-5 sm:py-6 font-black uppercase tracking-[0.16em] sm:tracking-[0.3em] hover:bg-[#4f4398] hover:text-white transition-all text-xs sm:text-sm shadow-2xl w-full sm:w-auto"
                >
                  {cv184Ui.ctaButton}
                </button>
              </div>
