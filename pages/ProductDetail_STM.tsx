  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen font-sans selection:bg-[#4f4398] selection:text-white">
      ...
      <div className="stm-detail bg-white text-gray-900">
                ...
                <div className="space-y-10">
                  {localizedProduct.highlights.map((item, idx) => (
                    <div key={idx} className="feature-line-item">
                      <div className="text-[10px] font-black text-gray-400 uppercase mb-1">Architecture Pillar 0{idx+1}</div>
          ...
          <section className="py-32 bg-[#0a0a0a] text-white">
            <div className="container mx-auto px-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                <div>
                  <div className="text-[#4f4398] tech-mono text-xs font-black uppercase tracking-[0.4em] mb-6">ARM Cortex-M4 Core</div>
                  <h2 className="text-6xl font-black uppercase mb-8 tracking-tighter">Compute Power</h2>
                ...
                <div className="bg-white/5 p-12 border border-white/10 rounded-sm">
                  <h4 className="tech-mono text-[10px] font-black text-[#4f4398] uppercase tracking-[0.3em] mb-12 text-center">Benchmarks</h4>
                      ...
                      <div key={idx} className="relative">
                        ...
                        <div className="h-1 w-full bg-white/10">
                          <div 
                            ...
                            style={{ width: stat.label.includes('Frequency') || stat.label.includes('Performance') ? '100%' : '60%' }}
                          ></div>
                        </div>
                      </div>
                    ))}
          ...
          <section className="py-32 bg-white border-b border-gray-100">
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mb-24">
                <div className="text-[#4f4398] tech-mono text-xs font-black uppercase tracking-[0.4em] mb-6">Integrated Precision Peripherals</div>
                <h2 className="text-6xl font-black uppercase mb-8 tracking-tighter">Analog & Control</h2>
                ...
                {sectionMap['analog-timers'].bullets?.map((bullet, idx) => {
                  ...
                  return (
                    <div key={idx} className="border-t-2 border-gray-100 pt-8">
                      <div className="text-[#4f4398] font-black tech-mono text-xs mb-4">IP-BLOCK-0{idx+1}</div>
        ...
        <section className="py-32 bg-white border-b border-gray-100">
          <div className="container mx-auto px-6">
            <h3 className="text-center text-xs font-black uppercase tracking-[0.5em] text-gray-400 mb-20">Commercial Applications</h3>
        ...
        <section className="py-32 bg-white">
          <div className="container mx-auto px-6">
            <div className="flex items-baseline justify-between mb-20 border-b-4 border-gray-900 pb-8">
              ...
              <div className="text-gray-400 font-bold uppercase tracking-widest text-xs">Technical Parameters</div>
            </div>
